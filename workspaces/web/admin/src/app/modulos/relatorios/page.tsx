...
const BASE_PATH = "/modulos/relatorios";

const MENU_ITEMS = [
  { key: "all", label: "Todos", href: BASE_PATH },
  { key: "fluxo-caixa", label: "Fluxo de caixa", href: `${BASE_PATH}?view=fluxo-caixa#fluxo-caixa` },
  { key: "compras", label: "Compras", href: `${BASE_PATH}?view=compras#compras` },
  { key: "producao", label: "Producao", href: `${BASE_PATH}?view=producao#producao` },
  { key: "pedidos", label: "Pedidos", href: `${BASE_PATH}?view=pedidos#pedidos` },
  ...
  return (
    <AdminSessionGate>
      {() => (
        ...
        >
          {(showAll || activeView === "fluxo-caixa") && (
