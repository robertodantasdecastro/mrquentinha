...
Este arquivo mapeia comandos de sessao para workflows padronizados.
...
Uso sugerido:
1. Ler `AGENTS.md` e memoria oficial.
2. Selecionar macro.
3. Executar workflow correspondente sem pular quality gate.
